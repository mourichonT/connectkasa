...
class SinistreTileState extends State<SinistreTile> {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  MyTextStyle.lotName(
                                      _signalement!.title, Colors.black87),
                                  MyTextStyle.annonceDesc(
                                      _signalement!.description, 13, 2),
                                  Divider(),
                                  Row(
                                    mainAxisAlignment:
                                        MainAxisAlignment.spaceBetween,
                                    children: [
                                      MyTextStyle.postDate(
                                          _signalement!.timeStamp),
                                      MyTextStyle.annonceDesc(
                                          _signalement!.statu ?? "N/A", 11, 2),
                                    ],
                                  )
                                ],
                              ),
  ...
  showAlertDialog(BuildContext context, String title) async {
    Widget cancelButton = TextButton(
      child: MyTextStyle.lotName("Annuler ", Colors.black87, 16),
      onPressed: () {
        Navigator.pop(context);
      },
    );
    Widget continueButton = TextButton(
      child: MyTextStyle.lotName("Supprimer ", Colors.black87, 16),
      onPressed: () async {
    ...
    AlertDialog alert = AlertDialog(
      title: MyTextStyle.lotName("Confirmation ", Colors.black87, 20),
      content: MyTextStyle.annonceDesc(
          "Etes-vous sûr de vouloir supprimer '$title' ", 16, 3),
      actions: [
        cancelButton,
        continueButton,
      ],
