    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => PostView(post, userPost, residence, uid)),
        );
        // Call the callback function with the value of postCount
      },
      child: Column(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                //PostsController(post: post, postCount: postCount),
              ],
            ),
          ),
        ],
