...
static Future<Map<String, dynamic>> checkDuplicatePost({
  ...
  final url = Uri.parse("https://check-similar-post-325705345982.us-central1.run.app"); // Remplacer par l'URL de ta Cloud Function
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (data.containsKey('status')) {
        ...
        return {
          'status': "new_post_created",  // Valeur par défaut si statut non trouvé
          'post_id': ""
        };
      }
    } else {
